...
def intro():
    for x in ("(EVERYTHING IS DARK)",
              "You feel around, using your hands to see.",
    ...
    for x2 in ("The rock released a boulder that was blocking the cave entrance.",
              "Three paths area revealed:"):
        time.sleep(2)
        print(x2)
    print()

    for x3 in ("Path #1: Exit forward trough the caves entrance, into the light.",
              "path #2: Explore the depths of the rear of the cave, into the darkness.",
              "Path #3: Climb down the vines into a bottomless hole into the ground."):
        time.sleep(2)
        print(x3)
    print()
    firstpath()
...
def firstpath():
    x = input("Which path will you choose? (1/2/3): ")
    if x == '1':
        print()
        path1()
    elif x == '2':
        ...
        print("Please answer 1, 2 or 3 only.")
        firstpath()


def path1():
    for x in ("You exit forward through the cave's entrance, into the light.",
    ...
    for x1 in '"Hello there!...':
        print(x1,end="",flush=True)
        time.sleep(b)
    print()

    for x2 in "...My name is APOLLO. I thought you were my sister, ARTEMIS...":
        print(x2,end="",flush=True)
        time.sleep(c)
    print()

    for x3 in "...Ah, now I remember you! Yes, you're looking for CHRONOS...":
        print(x3,end="",flush=True)
        time.sleep(c)
    print()

    for x4 in "...He's the one who trapped you in this time loop...":
        print(x4,end="",flush=True)
        time.sleep(c)
    print()

    for x5 in "...Yet, I cannot bring you to him...":
        print(x5,end="",flush=True)
        time.sleep(c)
    print()

    for x6 in "...Yet, I cannot bring you to him...":
        print(x6,end="",flush=True)
        time.sleep(c)
    print()

    for x7 in "...Only HERMES can do that...":
        print(x7,end="",flush=True)
        time.sleep(c)
    print()

    for x8 in "...However, I have heard that CHRONOS dwells at the base of this mountain.\"":
        print(x8,end="",flush=True)
        time.sleep(c)
    print()
    ...
    print()
    print()
    for x9 in ("There are two paths to take to the bottom of the mountain:",
              "Path #1: Take the set path down the mountain.",
              "Path #2: Scale down the side of the mountain."):
        print(x9,end="")
        time.sleep(a)
    print()
    secondpath()
...
def secondpath():
    x = input("Which path will you choose? (1/2): ")
    if x == '1':
        path1_1()
    elif x == '2':
        path1_2()
    else:
        print("Please answer 1 or 2 only.")
        secondpath()


def path1_1():
    print()
    for x in ("You begin walking down the mountain toward the bottom.",
              "The path is long and winding but the walk is not difficult.",
              "The sky is bright and blue and a warm breeze hits your face."):
        print(x, end="")
        time.sleep(a)

    for x1 in ('  "I could get used to this..."'):
        print(x1,end="",flush=True)
        time.sleep(b)
    ...
    for x in ('  --You think to yourself.',
              "A boy calls out to you."):
        time.sleep(a)
    print()

    for x1 in ('"Hey! Wait up!...'):
        print(x1,end="",flush=True)
        time.sleep(b)
    print()

    for x2 in ("...My name is ARES. I was just coming down the mountain for some fresh air..."):
        print(x2,end="",flush=True)
        time.sleep(c)
    print()

    for x3 in ("...Mount OLYMPUS is the highest reaching mountain on Earth and the air is specially crisp..."):
        print(x3,end="",flush=True)
        time.sleep(c)
    print()

    for x4 in ("...Anyhow, I see you're searching for the correct path, as we all are..."):
        print(x4,end="",flush=True)
        time.sleep(c)
    print()

    for x5 in ("...It's not my place to tell you which path is correct..."):
        print(x5,end="",flush=True)
        time.sleep(c)
    print()

    for x6 in ("...However, I will tell you this..."):
        print(x6,end="",flush=True)
        time.sleep(c)
    ...
    print()
    print()
    for x7 in ('..."ONLY THROUGH DARKNESS WILL FREEDOM BE ATTAINED"'):
        print(x7,end="",flush=True)
        time.sleep(b)
    print()
    time.sleep(a)
...
def path3():
    ...
    for character in s6:
        ...
        time.sleep(b)
    print()
    s7 = "...CHRONOS is just below he'll certainly TEST YOU when you meet him"
    for character in s7:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    ...
    if secondPath == '2':
        ...
        print()
        print("You continue down the vines until you touch the bottom.")
        time.sleep(a)
        print("You see a small old wom,an next to the largest red and black iron-wrought double doors you've ever seen.")
        time.sleep(a)
        ...
        print()
        print()
        print("Path #1: Forget the old women. Enter the doors and speak with CHRONOS.")
        time.sleep(a)
...
def path3_2():
    ...
    time.sleep(a)
    s1 = '"I understand. I know what it\'s like to miss home... tht\'s why I need to get out of here...'
    for character in s1:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
    ...
    for character in s2:
        ...
        time.sleep(c)
    print()
    print("You kneel in front of MOIRAE, allowing her to climb easily onto your back.")
    time.sleep(a)
    print("Standing up, you make your way back to the vine wall to make your ascent.")
    time.sleep(a)
    print("just as you grab the vines, the enormous red and black iron doors thrust open, slamming to halt.")
    time.sleep(a)
...
def startgame():
    ...
    x = input("Would you like to start the game? (Yes/No): ")
